    ...
    <footer className=" bg-slate-950 w-full">
      <div className="text-white justify-around self-center w-11/12 md:w-2/3 mx-auto">
        ...
        <p className="my-10 text-stone-500 mx-auto w-11/12">
          Website crafted by Daniel Lopez using React and TypeScript. If you
          seek a dedicated software developer with a passion for all things
          tech, let's
          <Link to="/contact" className="underline hover:text-amber-400 ml-1">
            connect.{" "}
          </Link>
        </p>
      </div>
